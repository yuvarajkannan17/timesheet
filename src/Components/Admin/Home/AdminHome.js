                    ...
                    <div className="row text-center ti-home-content mt-2">
                        ...
                        <div className="col mx-5 my-2 p-2 ">
                            ...
                            <div className='p-3 body'>
                                <div className='my-4 '>
                                    <button type='button' className='btn p-2 select-btn ' onClick={goToAdminAddTimesheetPage}>Add Timesheet</button>
                                </div>
                                <div className='my-4'>
                                    <button type='button' className='btn p-2 select-btn' onClick={goToAdminEditPage}>Edit Timesheet</button>
                                </div>
                                
                                <div className='my-4'>
                                    <button type='button' className='btn p-2 select-btn' onClick={goToAdminViewRejectPage}>View Rejected Timesheet</button>
                                </div>
                                <div className='my-4'>
                                    <button type='button' className='btn p-2 select-btn' onClick={goToCreateEmployeePage}>Create Employee</button>
                                </div>
