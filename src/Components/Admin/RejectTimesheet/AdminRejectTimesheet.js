...
function RejectTimesheet() {
    ...
    const [saveModalForEmployeeReject,setSaveModalForEmployeeReject]=useState(false);
    ...
    async function rejectDataSaveConfirmationFun() {
   ...
   async function editDataSaveFun(){
    ...
    return (
        ...
        {timesheetData && (<div className="ti-background-clr">
            ...
            <Modal className="custom-modal" style={{ left: '50%', transform: 'translateX(-50%)' }} dialogClassName="modal-dialog-centered" show={saveModalForEmployeeReject}  >
            <div className="d-flex flex-column modal-success p-4 align-items-center ">
              <img src={successCheck} className="img-fluid mb-4" alt="successCheck" />
              <p className="mb-4 text-center"> Your Timesheet has been Saved.</p>
              <button className="btn  w-100 text-white" onClick={() => { setSaveModalForEmployeeReject(false) }} style={{ backgroundColor: '#5EAC24' }}>Close</button>
            </div>
          </Modal>
